...
const SECTION_GUIDE = {
  ...
  "Global Weather (Macro Regime)": "Top-down rate backdrop: when borrowing costs are high, equity valuations face stronger pressure.",
  "Valuation Check (Price Tag vs History)": "Compares current valuation to historical anchors so you can see if you're paying a premium.",
  "Engine Room (Earnings & Growth)": "Checks if profit and revenue momentum are strong enough to justify the current price.",
  "Concentration Risk (Mag 7 Factor)": "Shows how much of the ETF is driven by a few mega-cap holdings.",
  "Traffic Light Panel": "Quick red/yellow/green dashboard across rates, valuation, growth, and risk.",
  "Data Quality Warning": "Flags when fundamental data is missing and analysis leans more on price history than company fundamentals.",
